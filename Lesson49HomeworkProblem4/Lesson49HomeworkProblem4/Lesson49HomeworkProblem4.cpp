...
/**
 * @brief Prints a number triangle with the specified length.
 *
 * @param length The length of the number triangle. Default is 10.
 */
void printNumberTriangle(int length = 10) {
...
int main()
{
	...
	cout << "=== Number Triangle Generator ===\n\n";

	cout << "Default triangle (length 10):\n";

	printNumberTriangle();

	printSeparator();

	int length = validatePositiveInteger("Enter the length of the number triangle: ", MIN_INPUT, MAX_INPUT);

	printSeparator();

	cout << "\nCustom triangle:\n";

	printNumberTriangle(length);
